...
class Topic extends \App\Entity\Topic implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Topic' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Topic' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Topic' . "\0" . 'creationDate', '' . "\0" . 'App\\Entity\\Topic' . "\0" . 'author', '' . "\0" . 'App\\Entity\\Topic' . "\0" . 'messages', '' . "\0" . 'App\\Entity\\Topic' . "\0" . 'deleted', '' . "\0" . 'App\\Entity\\Topic' . "\0" . 'valid'];
        }
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \App\Entity\Topic
    {
     ...
     * {@inheritDoc}
     */
    public function setCreationDate(\DateTimeInterface $creationDate): \App\Entity\Topic
    {
    ...
    public function getCount($id, $messages)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCount', [$id, $messages]);

        return parent::getCount($id, $messages);
    }
     ...
     * {@inheritDoc}
     */
    public function setAuthor(?\App\Entity\User $author): \App\Entity\Topic
    {
     ...
     * {@inheritDoc}
     */
    public function addMessage(\App\Entity\Message $message): \App\Entity\Topic
    {
     ...
     * {@inheritDoc}
     */
    public function removeMessage(\App\Entity\Message $message): \App\Entity\Topic
    {
     ...
     * {@inheritDoc}
     */
    public function setDeleted(?bool $deleted): \App\Entity\Topic
    {
     ...
     * {@inheritDoc}
     */
    public function setValid(?bool $valid): \App\Entity\Topic
    {
