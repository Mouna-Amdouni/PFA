...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AssociationAjoutInfoType' => ['privates', 'App\\Form\\AssociationAjoutInfoType', 'getAssociationAjoutInfoTypeService', true],
            'App\\Form\\AssociationEditFormType' => ['privates', 'App\\Form\\AssociationEditFormType', 'getAssociationEditFormTypeService', true],
            'App\\Form\\AssociationEditPAFormType' => ['privates', 'App\\Form\\AssociationEditPAFormType', 'getAssociationEditPAFormTypeService', true],
            ...
            'App\\Form\\EditProfile' => ['privates', 'App\\Form\\EditProfile', 'getEditProfileService', true],
            'App\\Form\\NewMessageType' => ['privates', 'App\\Form\\NewMessageType', 'getNewMessageTypeService', true],
            'App\\Form\\NewTopicType' => ['privates', 'App\\Form\\NewTopicType', 'getNewTopicTypeService', true],
            'App\\Form\\OldPostFormType' => ['privates', 'App\\Form\\OldPostFormType', 'getOldPostFormTypeService', true],
            'App\\Form\\OpportuniteType' => ['privates', 'App\\Form\\OpportuniteType', 'getOpportuniteTypeService', true],
            ...
            'App\\Form\\UserInscritFormType' => ['privates', 'App\\Form\\UserInscritFormType', 'getUserInscritFormTypeService', true],
            ...
            'App\\Form\\AssociationAjoutInfoType' => '?',
            'App\\Form\\AssociationEditFormType' => '?',
            'App\\Form\\AssociationEditPAFormType' => '?',
            ...
            'App\\Form\\NewMessageType' => '?',
            'App\\Form\\NewTopicType' => '?',
            'App\\Form\\OldPostFormType' => '?',
            'App\\Form\\OpportuniteType' => '?',
            'App\\Form\\ResetPasswordRequestFormType' => '?',
            'App\\Form\\UserFormType' => '?',
            'App\\Form\\UserInscritFormType' => '?',
