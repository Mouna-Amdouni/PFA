...
<h1>";
        // line 6
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["ass"]) || array_key_exists("ass", $context) ? $context["ass"] : (function () { throw new RuntimeError('Variable "ass" does not exist.', 6, $this->source); })()), "titre", [], "any", false, false, false, 6), "html", null, true);
        echo "</h1>
";
